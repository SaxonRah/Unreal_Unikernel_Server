...
```
.\build\Release\ue574_endpoint.exe --port 7777 --binlog ue574-real-client-v54_ds_reliable.binlog --experimental-control-replies --level-name /Game/NanoS_Testing --game-name /Game/NanoS_GMBP.NanoS_GMBP_C --post-welcome-ack-every 8 --post-join-datastream-open-probe --post-join-datastream-channel 2 --post-join-datastream-open-after 1 --post-join-datastream-header-mode reliable
```
...
```
python .\tools\dump_u5bl_binlog.py .\ue574-real-client-v54_ds_reliable.binlog > ue574-real-client.dump.txt
```
or
```
.\build\Release\ue574_binlog_dump.exe .\ue574-real-client-v54_ds_reliable.binlog --summary
```
